...
room_planes = [bproc.object.create_primitive('PLANE', scale=[500, 500, 500]),
               bproc.object.create_primitive('PLANE', scale=[500, 500, 500], location=[0, -1000, -500], rotation=[-1.570796, 0, 0]),
               bproc.object.create_primitive('PLANE', scale=[500, 500, 500], location=[0, 1000, -500], rotation=[1.570796, 0, 0]),
               bproc.object.create_primitive('PLANE', scale=[500, 500, 500], location=[1000, 0, -500], rotation=[0, -1.570796, 0]),
               bproc.object.create_primitive('PLANE', scale=[500, 500, 500], location=[-1000, 0, -500], rotation=[0, 1.570796, 0])]
